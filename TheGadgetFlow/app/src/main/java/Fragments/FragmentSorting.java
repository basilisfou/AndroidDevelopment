...
import RSS.RestClient.RestClientOldestGadget;
import Utils.CommonUtils;
import View.DividerItemDecorationHomeFeed;
import View.DividerItemDecorationWishList;

/**
 * Created by vasilis fouroulis on 29/2/2016.
 */
public class FragmentSorting extends Fragment {
    ...
    private final static String TAG = "FragmentSorting";
    private SharedPreferences sharedPreferences;
    private static OnScrolledListener mCallback;
    private static ImageButton categories; // the category button of bottom toolbar
    ...
    private CountDownTimer mCountDown = new CountDownTimer(300000, 300000) {
        ...
        public void onFinish() {
            if (mLayoutManager.findLastVisibleItemPosition()> 10 && anchor!=null)
...
//            Log.d(TAG,"LOCAL BROADCAST RECEIVER:    pos" + pos  + ", isSaved: " + isSaved);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            sortingStatement = savedInstanceState.getString(Constants.VALUE_SORTING);
//            if(gd.printLogs)Log.d(TAG,"sortingStatement::: " + sortingStatement);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent , Bundle savedInstanceState) {
        ...
        categories =(ImageButton)getActivity().findViewById(R.id.categories);
        v = inflater.inflate(R.layout.fragment_list_item_home_sorting, parent , false);
//        if(gd.printLogs)Log.d(TAG,"onCreateVIew -- FragmentSorting");
...
//            Log.d(TAG,"fetching Wish List");
    ...
    public void getGadget(int loadedPage) {
        ...
        if(Utils.CommonUtils.isNetworkAvailable(getActivity())) {
            RestClientOldestGadget restClientList = new RestClientOldestGadget();
            Call<MainRss> call = restClientList.getApiService().getGadgets(sortingStatement,loadedPage);
...
//                    Log.d(TAG,"t == " + t.toString());
            ...
            //No internet
//            Log.d(TAG,"Getting Gadget error no internet");
            if(getActivity() != null ) {
